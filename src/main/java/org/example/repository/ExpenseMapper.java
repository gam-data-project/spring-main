...
import org.example.dto.expense.response.ExpenseListItemDto;
...
public interface ExpenseMapper {
     ...
     */
    List<ExpenseOptionDto> selectDistinctMediumCategoriesByLarge(
     ...
     */
    List<ExpenseOptionDto> selectDistinctSmallCategoriesByLargeMedium(
            @Param("largeCategory") String largeCategory,
     ...
     */
    List<ExpenseOptionDto> selectDistinctExpenseTypesByCategory(
            @Param("largeCategory") String largeCategory,
            @Param("mediumCategory") String mediumCategory,
     ...
     * @return 총 건수
     */
    long countExpensePage(@Param("req") ExpenseSearchRequestDto request);
     ...
     * @return 페이지 데이터
     */
    List<ExpenseListItemDto> selectExpensePage(@Param("req") ExpenseSearchRequestDto request);
