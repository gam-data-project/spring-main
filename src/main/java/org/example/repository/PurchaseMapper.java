...
import org.example.dto.purchase.response.PurchaseListItemDto;
...
public interface PurchaseMapper {
    ...
    /** 대분류 DISTINCT 조회 */
    List<PurchaseOptionDto> selectDistinctLargeCategories();

    /** 선택한 대분류 기준 중분류 DISTINCT 조회 */
    List<PurchaseOptionDto> selectDistinctMediumCategoriesByLarge(
            @Param("largeCategory") String largeCategory
    );

    /** 선택한 대/중분류 기준 소분류 DISTINCT 조회 */
    List<PurchaseOptionDto> selectDistinctSmallCategoriesByLargeMedium(
            @Param("largeCategory") String largeCategory,
            @Param("mediumCategory") String mediumCategory
    );

    /** 선택한 대/중/소분류 기준 매입처 DISTINCT 조회 */
    List<PurchaseOptionDto> selectDistinctSuppliersByCategory(
            @Param("largeCategory") String largeCategory,
            @Param("mediumCategory") String mediumCategory,
    ...
    /** 페이징용 총 건수 조회 */
    long countPurchasePage(@Param("req") PurchaseSearchRequestDto request);

    /** 페이징 목록 조회 */
    List<PurchaseListItemDto> selectPurchasePage(@Param("req") PurchaseSearchRequestDto request);



    /** 저장/수정 폼용 제품명 옵션 조회 */
    List<PurchaseOptionDto> selectDistinctProductsByCategory(
            @Param("largeCategory") String largeCategory,
            @Param("mediumCategory") String mediumCategory,
            @Param("smallCategory") String smallCategory
    );
     ...
     * @return 총 건수
     */
    long countProductMappingPage(@Param("req") PurchaseProductMappingSearchPageRequestDto request);
     ...
     * @return 페이지 목록
     */
    List<PurchaseProductMappingListItemDto> selectProductMappingPage(
            @Param("req") PurchaseProductMappingSearchPageRequestDto request
    );
}
